...
valid="false"
flashsize=$(/root/flashrom/flashrom -p internal --ifd -i bios -r /tmp/backup.rom &> /dev/null && du -k /tmp/backup.rom | sed "s/[^0-9]//g")
...
/root/flashrom/flashrom -p internal -w /root/bios/rom.temp --ifd -i bios -N
